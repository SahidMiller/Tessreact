  ...
  for (let key in appState.openTabs) {
    tabs.push(
      <Tab
        ...
        isActive={
          appState.previousPaths[appState.previousPaths.length - 1] === key
        }
        setActiveTab={setActiveTab}
        path={key}
        closeTab={closeTab}
      ...
      <div id="editor-tabbar-right">
        <div id="btn-hmr-group">
          ...
          <div
            id="btn-hmr-main"
            className="btn"
            onClick={() => closeSideBar(close, tabs)}
          >
          ...
          <div
            ...
            className="btn"
            onClick={(event) =>
              handleHMRButtonClick(event, cbOpenSimulator_Main)
            }
          >
          ...
          <div
            ...
            className="btn"
            onClick={(event) =>
              handleHMRButtonClick(event, cbOpenSimulator_Ext)
            }
          >
